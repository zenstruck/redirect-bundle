        ...
        $rootNode
            ->children()
                ->scalarNode('redirect_class')
                    ->defaultNull()
                    ->validate()
                        ->ifTrue(static fn($value) => !\is_subclass_of($value, 'Zenstruck\RedirectBundle\Model\Redirect'))
                ...
                ->scalarNode('not_found_class')
                    ->defaultNull()
                    ->validate()
                        ->ifTrue(static fn($value) => !\is_subclass_of($value, 'Zenstruck\RedirectBundle\Model\NotFound'))
